...
var createScene= function(){
    ...
    var ground=new BABYLON.Mesh.CreateGroundFromHeightMap("ground","images/heightmap",200,200,20,0,100,scene,false,OnGroundCreated);
    function OnGroundCreated(){
        var groundMaterial=new BABYLON.StandardMaterial("groundMaterial",scene);
        groundMaterial.diffuseTexture=new BABYLON.Texture("images/grass",scene);
