...
var createScene= function(){
    ...
    //input name,path,width,height,rgb color,scene,whether to change, what to do after show;
    var ground=new BABYLON.Mesh.CreateGroundFromHeightMap("ground","images/heightmap.jpeg",200,200,20,0,100,scene,false,OnGroundCreated);
