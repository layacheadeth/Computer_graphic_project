...
function modifySettings(){
    ...
    document.addEventListener("mspointerlockchange",mspointerLockListener);
    document.addEventListener("mozpointerlockchange",mozpointerLockListener);
    document.addEventListener("webkitpointerlockchange",webkitpointerLockListener);

    function pointerLockListener(){
        var element=document.pointerLockElement || document.mozpointerLockListener || document.mspointerLockListener || document.webkitpointerLockListener || null;
        if(element){
