var canvas = document.getElementById("renderCanvas");
        ...
        /******* Add the create scene function ******/
            ...
            BABYLON.SceneLoader.ImportMeshAsync("", "/static/Model/city-street-babylon/", "city-street.babylon").then((result)=>{
                const mesh=scene.getMeshByName("BUIL");
                mesh.checkCollisions=true;
                const mesh1=scene.getMeshByName("Concret");
                ...
                // result.meshes[2].checkCollisions=true;
                // result.meshes[3].checkCollisions=true;
                // result.meshes[4].checkCollisions=true;
                // result.meshes[5].checkCollisions=true;
                // result.meshes[6].checkCollisions=true;

                // result.meshes[7].checkCollisions=true;
                // result.meshes[8].checkCollisions=true;
                // result.meshes[9].checkCollisions=true;
                // result.meshes[10].checkCollisions=true;
                // result.meshes[11].checkCollisions=true;
                // result.meshes[12].checkCollisions=true;
                // result.meshes[13].checkCollisions=true;

                // result.meshes[14].checkCollisions=true;
                // result.meshes[15].checkCollisions=true;
                // result.meshes[16].checkCollisions=true;
                // result.meshes[17].checkCollisions=true;
                // result.meshes[18].checkCollisions=true;
                // result.meshes[19].checkCollisions=true;
                // result.meshes[20].checkCollisions=true;

                // result.meshes[21].checkCollisions=true;
                // result.meshes[22].checkCollisions=true;
                // result.meshes[23].checkCollisions=true;
                // result.meshes[24].checkCollisions=true;
                // result.meshes[25].checkCollisions=true;
                // result.meshes[26].checkCollisions=true;
                // result.meshes[27].checkCollisions=true;
            ...
            // ground
            var gnd=BABYLON.MeshBuilder.CreateGround("gnd", {width: 70, height: 70, subdivsions: 1}, scene);
